...
<head>
    ...
    <title>Eliminar Instrumento de Músico</title>
...
<body>
    ...
    <div class="container mt-5">
        <h2 class="mb-4">Eliminar Instrumento de Músico</h2>
        <form action="deleteInstrument.php" method="POST" class="mb-4">
            <div class="row g-3 align-items-center">
                <div class="col-auto">
                    <label for="rut" class="col-form-label">Seleccione el músico:</label>
                </div>
                <div class="col-auto">
        ...
        <?php if (!empty($selectedRut) && !empty($instrumentos)) : ?>
            <form action="../controller/deleteInstrumentController.php" method="POST">
                <input type="hidden" name="rut" value="<?= htmlspecialchars($selectedRut, ENT_QUOTES, 'UTF-8') ?>">
                <div class="row g-3 align-items-center">
                    <div class="col-auto">
                        <label for="instrumento" class="col-form-label">Seleccione el instrumento:</label>
                    </div>
                    <div class="col-auto">
        ...
        <div id="resultado" class="mt-4">
            <?php if (isset($_GET['mensaje'])) : ?>
                <p><?= htmlspecialchars($_GET['mensaje'], ENT_QUOTES, 'UTF-8') ?></p>
            <?php endif; ?>
        </div>
    </div>
</body>
